...
const Template2 = ({ data, aiSummary = "" }) => {
  return (
    <div className="resume-container">
      ...
      <div className="resume-sidebar">
        ...
        {data.personal?.linkedin && <p><a href={data.personal.linkedin}>LinkedIn</a></p>}
        {data.personal?.github && <p><a href={data.personal.github}>GitHub</a></p>}
      </div>
